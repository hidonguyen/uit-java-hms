...
public class UserPresenter {
        ...
        this.view.onDelete(_ -> {
            ...
            if (selectedRow >= 0 && selectedRow < users.size()) {
                ...
                int confirm = JOptionPane.showConfirmDialog(view,
                        "Are you sure you want to delete user: " + user.getUsername() + "?", "Confirm Delete",
        ...
        this.view.onResetPassword(_ -> {
            ...
            if (selectedRow >= 0 && selectedRow < users.size()) {
                ...
                int option = JOptionPane.showConfirmDialog(view, passwordField,
                        "Enter new password for: " + user.getUsername(), JOptionPane.OK_CANCEL_OPTION);
                ...
                protected Integer doInBackground() {
                    try {
                        ...
                        if (existingUser != null
                                && (user.getId() == null || !existingUser.getId().equals(user.getId()))) {
                            modal.showStyledError(Constants.ValidateMessage.USERNAME_IS_ALREADY_TAKEN,
                                    Constants.ErrorTitle.USER);
                            return -1;
                        }
    ...
    static class UserTableModel extends AbstractTableModel {
        private final String[] cols = { "Id", "Username", "Role", "Status", "Last Login At", "Created At", "Created By",
                "Updated At", "Updated By" };
        private final List<User> data;

        UserTableModel(List<User> data) {
            this.data = data;
        }
        ...
        public Object getValueAt(int r, int c) {
            ...
            return switch (c) {
                ...
                case 2 -> o.getRole();
                case 3 -> o.getStatus();
                case 4 -> o.getLastLoginAt() == null ? null
                        : o.getLastLoginAt().format(DateTimeFormatter.ofPattern(Constants.DateTimeFormat.ddMMyyyyHHmm));
                case 5 -> o.getCreatedAt() == null ? null
                        : o.getCreatedAt().format(DateTimeFormatter.ofPattern(Constants.DateTimeFormat.ddMMyyyyHHmm));
                case 6 -> o.getCreatedBy();
                case 7 -> o.getUpdatedAt() == null ? null
