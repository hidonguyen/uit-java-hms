...
public class GuestView extends JPanel {
    ...
    public void showErrorMessage(String message) {
        JOptionPane.showMessageDialog(this, message, "Error - " + Constants.ErrorTitle.GUEST,
                JOptionPane.ERROR_MESSAGE);
    }

    public void showSuccessMessage(String message) {
        JOptionPane.showMessageDialog(this, message, "Success - " + Constants.ErrorTitle.GUEST,
